  ...
  case 'magician':
    {
      ...
      createCardElement('card37', 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT4QM1dj9DZ4G3zFJZ83vkKDHizWfys1ZFOIA&usqp=CAU', 'fu');
      ...
      createCardElement('card45', 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT4QM1dj9DZ4G3zFJZ83vkKDHizWfys1ZFOIA&usqp=CAU', 'fu');
      createCardElement('card46', 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT4QM1dj9DZ4G3zFJZ83vkKDHizWfys1ZFOIA&usqp=CAU', 'fu');
...
searchButton.addEventListener('click', () => {
  ...
  }).catch(error => alert('カード生成ができませんでした。以下の点をご確認ください。○正しいAPIキーが登録されているか ○正しい検索エンジンIDが登録されているか  ○検索結果が1件以上あるか'));
});
//カードクリック時の処理
